...
public class PrivateMessageService {
    ...
    public List<PrivateChatMessage> getAllMessagesBySender(User sender){
        return privateChatMessageRepository.findDistinctByReceiver(sender);
    }
    public int countUnreadMessages(User receiver,User sender,boolean status){
        return privateChatMessageRepository.countPrivateChatMessagesByReceiverAndSenderAndStatus(receiver,sender,status);
    }
...
//    }
    ...
    public int getUnreadMessages(String email,boolean status){
        return privateChatMessageRepository.countPrivateChatMessagesByReceiver_EmailAndStatus(email,status);
    }
}
