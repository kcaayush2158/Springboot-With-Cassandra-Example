    ...
    setInterval(function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                var results = '';
                for (var i = 0; i <= obj.length; i++) {
                    template = '<li> <div class="message"> <div class="row"> <img src="' + data[i].user.profilePhoto + ' " height="50" > <b ><h6 style="font-size: 16px;color: #004a95;" class="ml-2">' + data[i].user.username + ' </h6><p class="ml-2">  ' + data[i].message + ' </p></b></div></div></li>'
                    results += template;
